...
export default function Calc(){
    ...
    const loanSubtotal = (Number(loanCapital) + Number(loanInterest) + Number(loanFee));
    const loanSubtotalCost = (Number(loanInterest) + Number(loanFee)).toFixed(2);
    ...
    const taxes = (Number(stampTax) + Number(chequesTax) + Number(IVATax));

    const credit = (Number(loanSubtotal) + taxes).toFixed(2);
    ...
    return (
        <>
            ...
            <form className="container mt-3" style={{"maxWidth": "500px"}} id="printable">
                ...
                <div className="input-group mb-3">
                    <span className="input-group-text">{t("To be cancelled")}</span>
                    <span className="input-group-text">$</span>
